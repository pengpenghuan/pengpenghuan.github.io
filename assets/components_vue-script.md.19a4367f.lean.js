import{_ as B,d as F,j as c,H as r,o as u,c as d,a5 as C,a6 as m,C as s,J as e,E as p,a as l,t as f,F as v,b}from"./chunks/framework.bf5fcbf3.js";const D=F({name:"InputDemo",setup(){const o=c(),n=c();function a(){n.value=o.value}return{input:o,content:n,onSubmit:a}}}),A={style:{"margin-top":"16px"}};function _(o,n,a,t,x,E){const y=r("xl-button");return u(),d(v,null,[C(s("input",{class:"input",type:"text","onUpdate:modelValue":n[0]||(n[0]=i=>o.input=i)},null,512),[[m,o.input]]),e(y,{type:"primary",onClick:o.onSubmit},{default:p(()=>[l("提交")]),_:1},8,["onClick"]),s("div",A,"输出内容："+f(o.content),1)],64)}const g=B(D,[["render",_],["__scopeId","data-v-e09972cf"]]),h={style:{"margin-top":"16px"}},k=F({__name:"vue-script.md.demo.37702fda",setup(o){const n=c(),a=c();function t(){a.value=n.value}return(x,E)=>{const y=r("xl-button");return u(),d(v,null,[C(s("input",{class:"input",type:"text","onUpdate:modelValue":E[0]||(E[0]=i=>n.value=i)},null,512),[[m,n.value]]),e(y,{type:"primary",onClick:t},{default:p(()=>[l("提交")]),_:1}),s("div",h,"输出内容："+f(a.value),1)],64)}}});const S=B(k,[["__scopeId","data-v-fe6f04b5"]]);const I=F({setup(){const o=c(),n=c();function a(){n.value=o.value}return()=>e(v,null,[C(e("input",{class:"input input-tsx",type:"text","onUpdate:modelValue":t=>o.value=t},null),[[m,o.value]]),e(r("xl-button"),{type:"primary",onClick:a},{default:()=>[l("提交")]}),e("div",{style:"margin-top: 16px"},[l("输出内容："),n.value])])}}),V=s("h1",{id:"vue-script",tabindex:"-1"},[l("Vue Script "),s("a",{class:"header-anchor",href:"#vue-script","aria-label":'Permalink to "Vue Script"'},"​")],-1),j=s("h2",{id:"基础用法",tabindex:"-1"},[l("基础用法 "),s("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1),w=s("p",null,"基础的按钮用法。",-1),O=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    </>)")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")])])])],-1),H=JSON.parse('{"title":"Vue Script","description":"","frontmatter":{},"headers":[],"relativePath":"components/vue-script.md","filePath":"components/vue-script.md","lastUpdated":1694051949000}'),R={name:"components/vue-script.md"},M=Object.assign(R,{setup(o){return(n,a)=>{const t=r("demo");return u(),d("div",null,[V,j,w,e(t,{customClass:"demoblock-custom",sourceCode:`<template>
...
`},{highlight:p(()=>[O]),default:p(()=>[e(g)]),_:1}),$,z,e(t,{customClass:"demoblock-custom",sourceCode:`<template>
  <input class="input" type="text" v-model="input"/>
  <xl-button type="primary" @click="onSubmit">提交</xl-button>
  <div style="margin-top: 16px">输出内容：{{ content }}</div>
</template>
