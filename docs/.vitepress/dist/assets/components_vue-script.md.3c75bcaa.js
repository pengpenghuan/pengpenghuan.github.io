...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"    </>)")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"})")])])])],-1),H=JSON.parse('{"title":"Vue Script","description":"","frontmatter":{},"headers":[],"relativePath":"components/vue-script.md","filePath":"components/vue-script.md","lastUpdated":1692672843000}'),R={name:"components/vue-script.md"},M=Object.assign(R,{setup(o){return(n,a)=>{const t=r("demo");return u(),d("div",null,[V,w,O,e(t,{customClass:"demoblock-custom",sourceCode:`<template>
...
`},{highlight:p(()=>[U]),default:p(()=>[e(f(I))]),_:1})])}}});export{H as __pageData,M as default};
